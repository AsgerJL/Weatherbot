...
action_endpoint = EndpointConfig(url="https://weatherbot-actions.herokuapp.com/webhook")
...
input_channel = MyNewInput(url='https://weatherbot-actions.herokuapp.com/webhook')
